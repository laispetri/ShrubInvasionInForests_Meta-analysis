...
p3<-
  ...
  annotate("text", y=2.5, x=-0.36, label="Effect Size (mean+95%PI)", color="black", angle=90,size=6) +
  annotate("text", y=2.5, x=-0.48, label="Impact on native community", color="black", angle=90,size=8)
```
...
```{r}
#saves
png(file.path(graph.wd,"ESNatInv_Predictions.png.png"),width=12, height=9, res=300,units="in")
grid.arrange(p1,p2,p3,inset_plot,p4,inset_plot2,nrow=2, ncol=2)
dev.off()
```
