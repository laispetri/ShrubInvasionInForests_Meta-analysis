...
# saves
ggsave(file.path(graph.wd,"ESNatInv_ForestPlot.png"), plot = last_plot(), width=6.8, height=5.2, dpi = 600, units="in")
```
...
# saves
ggsave(file.path(graph.wd,"ESNatInv_PDF.png"), plot = last_plot(), width=4.6, height=5.2, dpi = 600, units="in")
```
...
p4<-ggplot(data=forest, aes(y=index, x=mean, xmin=`2.5%`, xmax=`97.5%`))+ 
...
theme(text=element_text(size=22, color="black"),
  ...
  geom_text_repel(aes(label = n),direction="both",color=c(Lightcolor,Nutrientcolor,Watercolor),size=6, point.size=12,segment.colour = NA)+
   annotate("text", x=-0.5, y=0.95, label="(d)", color="black", fontface = "bold", size=6)
```
...
ggplot(aes(ESNatPred)) +
  ...
  scale_color_manual(values=c(Lightcolor),
                     labels=c("Light")) +
  scale_fill_manual(values=c(Lightcolor), 
                    labels=c("Light")) +
  scale_shape_manual(values=c(16),labels=c("Light")) +
  xlab(" ") +
  ...
  theme(text=element_text(size=20, color="black"),
      ...
      axis.text.x = element_text(size=19,color="white"),
      panel.border = element_blank())+
  ...
  annotate("text", x=-1.6, y=-0.15, label="lower", color="black", fontface = "italic",size=5) +
  annotate("text", x=1.6, y=-0.15, label="higher", color="black", fontface = "italic",size=5)+
  annotate("text", x=0, y=-0.15, label="Resource availability", color="black", fontface = "bold.italic",size=5) +
  annotate("segment", y=0.05, yend=1.95, x=-2.45, xend=-2.45, color="black", size=1.3, arrow=arrow(length = unit(0.03, "npc"), ends = 'last', type = "open")) +
  annotate("text", y=0, x=-2.57, label="lower", color="black", fontface = "italic",angle=90, size=5) +
  annotate("text", y=1.95, x=-2.57, label="higher", color="black", fontface = "italic", angle=90, size=5)+
  annotate("text", y=1, x=-2.57, label="Invader performance", color="black", fontface = "bold.italic", angle=90, size=5)+
   annotate("text", x=-1.55, y=2.15, label="(a) Light", color="black", fontface = "bold", size=6)
```

```{r model1: ESInv~ESNat EN plot [SOIL NUTRIENT], include=FALSE}
# plotting real data in the background and the prediction lines on top
AbioticDataModelSoil <- AbioticDataModel  %>% filter(AbioticID==2)
p2<-ESInvPred %>% 
  filter(AbioticID==2) %>% 
  ggplot(aes(ESNatPred)) +
  geom_hline(yintercept=0, linetype="dashed",
             color = "gray", size=1.5) +
  geom_line(aes(y=ESInvPred, colour = as.factor(Abiotic_CATEGORY), group = as.factor(Abiotic_CATEGORY)), size=1.5) +
  geom_point(data = AbioticDataModelSoil, aes(ESNatmean, ESInvmean, 
                                     color = as.factor(Abiotic_CATEGORY),
                                     group = as.factor(Abiotic_CATEGORY),
                                     shape = as.factor(Abiotic_CATEGORY)),size=5,alpha=0.7) +
  theme_bw()+
  ...
  coord_cartesian(ylim = c(-0.2, 2.1), 
                  ...
                  clip = "off")+
  geom_ribbon(aes(ymin=CI25, ymax=CI975, group = as.factor(Abiotic_CATEGORY), fill = as.factor(Abiotic_CATEGORY)), alpha=0.2) +
  scale_color_manual(values=c(Nutrientcolor),
                     labels=c("Soil nutrient")) +
  scale_fill_manual(values=c(Nutrientcolor), 
                    labels=c("Soil nutrient")) +
  scale_shape_manual(values=c(17),labels=c("Soil nutrient")) +
  ...
  theme(text=element_text(size=20, color="black"),
      ...
      axis.text.x = element_text(size=19),
      axis.title.y = element_text(size=19,color="white"),
      panel.border = element_blank())+
  annotate("segment", x=-1.9, xend=1.9, y=-0.25, yend=-0.25, color="black", size=1.3, arrow=arrow(length = unit(0.03, "npc"), ends = 'last', type = "open")) +
  annotate("text", x=-1.7, y=-0.15, label="lower", color="black", fontface = "italic",size=5) +
  annotate("text", x=1.7, y=-0.15, label="higher", color="black", fontface = "italic",size=5)+
  annotate("text", x=0, y=-0.15, label="Resource availability", color="black", fontface = "bold.italic",size=5) +
  annotate("text", x=-1.3, y=2.15, label="(b) Soil nutrient", color="black", fontface = "bold", size=6)
```

```{r model1: ESInv~ESNat EN plot [SOIL WATER], include=FALSE}
# plotting real data in the background and the prediction lines on top
AbioticDataModelWater <- AbioticDataModel %>% filter(AbioticID==3)
p3<-ESInvPred %>% 
  filter(AbioticID==3) %>% 
ggplot(aes(ESNatPred)) +
  geom_hline(yintercept=0, linetype="dashed",
             color = "gray", size=1.5) +
  geom_line(aes(y=ESInvPred, colour = as.factor(Abiotic_CATEGORY), group = as.factor(Abiotic_CATEGORY)), size=1.5) +
  geom_point(data = AbioticDataModelWater, aes(ESNatmean, ESInvmean, 
                                     color = as.factor(Abiotic_CATEGORY),
                                     group = as.factor(Abiotic_CATEGORY),
                                     shape = as.factor(Abiotic_CATEGORY)),size=5,alpha=0.7) +
  theme_bw()+
  ...
  coord_cartesian(ylim = c(-0.2, 2.1), 
                  ...
                  clip = "off")+
  geom_ribbon(aes(ymin=CI25, ymax=CI975, group = as.factor(Abiotic_CATEGORY), fill = as.factor(Abiotic_CATEGORY)), alpha=0.2) +
  scale_color_manual(values=c(Watercolor),
                     labels=c("Soil water")) +
  scale_fill_manual(values=c(Watercolor), 
                    labels=c("Soil water")) +
  scale_shape_manual(values=c(15),labels=c("Soil water")) +
  xlab("Abiotic Effect Size") +
  ylab("Invasive Effect Size (mean+95%PI)\n") +
  theme(text=element_text(size=20, color="black"),
        legend.position="none",
  ...
  annotate("text", y=1.95, x=-2.57, label="higher", color="black", fontface = "italic", angle=90, size=5)+
  annotate("text", y=1, x=-2.57, label="Invader performance", color="black", fontface = "bold.italic", angle=90, size=5)+
   annotate("text", x=-1.3, y=2.15, label="(c) Soil water", color="black", fontface = "bold", size=6)
```
...
#saves
png(file.path(graph.wd,"ESInvAbiotic_Pred.png"),width=12, height=9, res=600,units="in")
grid.arrange(p1,p2,p3,p4,nrow=2, ncol=2)
dev.off()
```
...
inset_plot <-
  ...
  geom_errorbarh(data=forest, height=.1, size=1,color=forest$treatment2) +
  geom_point(data = forest, size=6, shape=forest$shape, color=forest$treatment2,fill=forest$treatment,stroke=1)+
    scale_x_continuous(limits=c(-0.8,0.15), name=xname, breaks = c(-0.8, -0.4, 0)) +
  scale_y_continuous(name = "title\n\n", breaks=1:nrow(forest),trans="reverse", labels=NULL) +
  geom_vline(xintercept=0, linetype="dashed", alpha=.5, size=1)+
  theme_bw()+
  ...
  theme(panel.spacing = unit(1, "lines"),
      ...
      axis.title.y=element_text(color="white"),
      axis.line = element_line(colour = "black"))+
  geom_text_repel(aes(label = n),direction="both",color=c(PPcolor,ENcolor,BRcolor),size=6, point.size=12,segment.colour = NA)+
   annotate("text", x=-0.8, y=0.85, label="(d)", color="black", fontface = "bold", size=6)
``` 
...
```{r model1: ESNat~ESInv plot [PROPAGULE PRESSURE], include=FALSE}
## ESNat~ESInv with predictions by mechanism

BioticDataModelPP <- BioticDataModel %>% filter(Mechanismdummy=="Propagule pressure")

p1<-
  ESNatPred %>% 
  filter(Mechanism==1) %>% 
  ggplot(aes(x=ESInvPred)) +
  geom_hline(yintercept=0, linetype="dashed",
             color = "gray", size=1.5) +
  geom_point(data = BioticDataModelPP, aes(ESInvmean, ESNatmean,
                                     color = as.factor(Mechanismdummy),
                                     group = as.factor(Mechanismdummy)),
                                     shape=15,size=3,alpha=0.8) +
  ...
  scale_color_manual(values=c(PPcolor))+
    scale_fill_manual(values=c(PPcolor))+
  ...
  theme(legend.position="none",
        ...
        axis.title.y = element_text(size = 21,color="white"),
        axis.text.y = element_text(size=19),
      axis.text.x = element_text(size=19,color="white"),
        axis.line = element_line(colour = "black"),
      panel.border = element_blank(),
  ...
  annotate("text", y=1.75, x=-0.23, label="lower", color="black", fontface = "italic", angle=90, size=6)+
  annotate("text", y=0, x=-0.23, label="Impact", color="black", fontface = "bold.italic", angle=90, size=6)+
   annotate("text", x=0.59, y=2.1, label="(a) Propagule pressure", color="black", fontface = "bold", size=6)# +
  # annotate("text", y=0, x=-0.325, label="Effect Size (mean+95%PI)", color="black", angle=90,size=6)

```

```{r model1: ESNat~ESInv plot [LOW BIOTIC RESISTANCE], include=FALSE}
## ESNat~ESInv with predictions by mechanism

BioticDataModelBR <- BioticDataModel %>% filter(Mechanismdummy=="Low biotic resistance")
...
p2<-
  ...
  geom_hline(yintercept=0, linetype="dashed",
             color = "gray", size=1.5) +
  geom_point(data = BioticDataModelBR, aes(ESInvmean, ESNatmean,
                                     color = as.factor(Mechanismdummy),
                                     group = as.factor(Mechanismdummy)),
  ...
  scale_x_continuous(expand = c(0,0)) +
  coord_cartesian(ylim = c(-2.1, 2), xlim=c(0,2), clip = "off")+
  scale_color_manual(values=c(BRcolor))+
    scale_fill_manual(values=c(BRcolor))+
  geom_ribbon(aes(ymin=CI25, ymax=CI975, group = as.factor(Mechanismdummy), fill = as.factor(Mechanismdummy)), alpha=0.2) +
  ...
  theme(legend.position="none",
        ...
        axis.title.y = element_text(size = 21, color="white"),
        axis.text.y = element_text(size=19,color="white"),
         axis.text.x = element_text(size=19),
        axis.line = element_line(colour = "black"),
      panel.border = element_blank(),
      plot.margin = margin(1,10,1,1))+  #defines margin so the graph does not cut off) 
  ...
  annotate("text", x=1.8, y=-1.95, label="higher", color="black", fontface = "italic", size=6)+
  annotate("text", x=1, y=-1.95, label="Performance", color="black", fontface = "bold.italic", size=6)  +
   annotate("text", x=0.63, y=2.1, label="(b) Low biotic resistance", color="black", fontface = "bold", size=6)

```

```{r model1: ESNat~ESInv plot [EMPTY NICHES], include=FALSE}
## ESNat~ESInv with predictions by mechanism

BioticDataModelBR <- BioticDataModel %>% filter(Mechanismdummy=="Empty niches")
...
p3<-
  ...
  scale_x_continuous(expand = c(0,0)) +
  coord_cartesian(ylim = c(-2.1, 2), xlim=c(0,2), clip = "off")+
  scale_color_manual(values=c(ENcolor))+
    scale_fill_manual(values=c(ENcolor))+
  geom_ribbon(aes(ymin=CI25, ymax=CI975, group = as.factor(Mechanismdummy), fill = as.factor(Mechanismdummy)), alpha=0.2) +
  xlab("Invasive Effect Size") +
  # xlab(" ")+
  ylab(" \n\n ") +
  ...
  annotate("text", y=1.75, x=-0.23, label="lower", color="black", fontface = "italic", angle=90, size=6)+
  annotate("text", y=0, x=-0.23, label="Impact", color="black", fontface = "bold.italic", angle=90, size=6)+
   annotate("text", x=0.44, y=2.1, label="(c) Empty niches", color="black", fontface = "bold", size=6) +
  annotate("text", y=0, x=-.36, label="Effect Size (mean+95%PI)", color="black", angle=90,size=6) +
  annotate("text", y=0, x=-.48, label="Impact on native community", color="black", angle=90,size=8)
```
...
```{r}
#observations per mechanism
BioticDataModelMP <- BioticDataModel %>% mutate(MultipleInvader=ifelse(MultipleInvader==0, 2, 1))

obs <- BioticDataModelMP %>% count(MultipleInvader)

J <- nrow(BioticDataModelMP)
StudyID <- BioticDataModelMP$StudyID
Category <- BioticDataModelMP$MultipleInvader
invESavemean <- BioticDataModelMP$ESInvmean
invESavesd <- BioticDataModelMP$ESInvSD
natESavemean <- BioticDataModelMP$ESNatmean
natESavesd <- BioticDataModelMP$ESNatSD
W <- length(unique(BioticDataModelMP$StudyID))
M <- max(BioticDataModelMP$ESInvSD, na.rm = T)
N <- max(BioticDataModelMP$ESNatSD, na.rm = T)
invpred<-seq(0,2,0.1)
K <- length(unique(BioticDataModelMP$MultipleInvader))
R <- K+1
...
```{r include=FALSE}
# organizing data for forest plot (slopes, inset)
samplesize <- BioticDataModelMP %>% group_by(MultipleInvader) %>% add_tally() %>% ungroup() %>% select(MultipleInvader, n) %>% distinct() %>%
...
inset_plot2 <-
  ...
  geom_point(data = forest, size=6, shape=c(24,21), stroke=1,color=c(Multicolor,Singlecolor),fill=c("white",Singlecolor))+
    scale_x_continuous(limits=c(-0.6,.5), name=xname) +
scale_y_continuous(name = "\n\n", breaks=1:nrow(forest),trans="reverse", labels = c("Single invader", "Multiple Invader")) +
geom_vline(xintercept=0, linetype="dashed", alpha=.5, size=1)+
theme_bw()+
theme(panel.spacing = unit(1, "lines"),
      panel.grid = element_blank(),
      ...
      axis.line = element_line(colour = "black"),
      axis.title.y=element_text(color="white"))+
  geom_text_repel(aes(label = n),direction="both",color=c(Multicolor,Singlecolor),size=6, point.size=12,segment.colour = NA)+
   annotate("text", x=-0.6, y=0.85, label="(f)", color="black", fontface = "bold", size=6)
``` 

```{r include=FALSE}
# data prep for ESNat~ESInv with predictions by number of invaders + inset
## Real data (calculated values)
BioticDataModelMP<- BioticDataModelMP %>% 
   mutate(MultInvdummy = ifelse(MultipleInvader==1, "Multiple invaders", "Single invader"))

range(BioticDataModelMP$ESInvmean)
range(BioticDataModelMP$ESNatmean)
...
p4 <-
  ...
  geom_hline(yintercept=0, linetype="dashed",
             color = "gray", size=1.5) +
  geom_point(data = BioticDataModelMP, aes(invESavemean, natESavemean,
  ...
  annotate("text", x=1, y=-2, label="Performance", color="black", fontface = "bold.italic", size=6) +
   annotate("text", x=0.09, y=2.13, label="(e)", color="black", fontface = "bold", size=6)+
  annotate("segment", y=2, yend=-1.9, x=-0.15, xend=-0.15, color="black", size=1.3, arrow=arrow(length = unit(0.03, "npc"), ends = 'last', type = "open")) +
  annotate("text", y=-1.9, x=-0.23, label="higher", color="black", fontface = "italic",angle=90, size=6) +
  annotate("text", y=1.75, x=-0.23, label="lower", color="black", fontface = "italic", angle=90, size=6)+
  annotate("text", y=0, x=-0.23, label="Impact", color="black", fontface = "bold.italic", angle=90, size=6)
...
```{r}
#saves
png(file.path(graph.wd,"ESNatInv_Predictions.png"),width=12, height=13.5, res=600,units="in")
grid.arrange(p1,p2,p3,inset_plot,p4,inset_plot2,nrow=3, ncol=2)
dev.off()
```
